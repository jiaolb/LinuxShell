...
img1, n = filter_brightness_low(dev2_fp, dev2_fpld, (23,23), 50)
cv2.imshow("dev201", img1)

img2, n = filter_brightness_low(dev2_fp, dev2_fpld, (23,23), 80)
cv2.imshow("dev202", img2)

img3, n = filter_brightness_low(dev2_fp, dev2_fpld, (23,23), 127)
...
img1,n = filter_without_red(dev3_ori, 65)
cv2.imshow("dev201", img1)

img2,n = filter_without_red(dev3_fp, 65)
cv2.imshow("dev202", img2)

img3,n = filter_without_red(dev3_fpld, 65)
cv2.imshow("dev203", img3)
'''
